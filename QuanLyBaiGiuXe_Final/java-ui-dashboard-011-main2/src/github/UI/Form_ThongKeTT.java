 ...
 * @author NHUT
 */
public class Form_ThongKeTT extends javax.swing.JPanel {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblts, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jLabel11.setText("THỐNG KÊ LƯỢT GỬI XE THÁNG");
...
void filltable() {
        ...
        List<Object[]> list = dao.getTTMonth(NgayDT, NgayKT);
        for (Object[] row : list) {
            model.addRow(row);
            lbltt.setText(row[1].toString());
            lblts.setText(row[0].toString());
